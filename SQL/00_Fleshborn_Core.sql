...
-- --------------------------------------------------------------------------
-- Identity and custom presentation.
...
('COLOR_FLESHBORN_PRIMARY',   0.36, 0.055, 0.42, 1),
('COLOR_FLESHBORN_SECONDARY', 0.82, 0.72, 0.20,  1);
...
('FLESHBORN_CIV_ATLAS', 256, 'Fleshborn_Civ_256.dds', 1, 1),
('FLESHBORN_CIV_ATLAS', 128, 'Fleshborn_Civ_128.dds', 1, 1),
('FLESHBORN_CIV_ATLAS', 80,  'Fleshborn_Civ_80.dds',  1, 1),
('FLESHBORN_CIV_ATLAS', 64,  'Fleshborn_Civ_64.dds',  1, 1),
('FLESHBORN_CIV_ATLAS', 45,  'Fleshborn_Civ_45.dds',  1, 1),
('FLESHBORN_CIV_ATLAS', 32,  'Fleshborn_Civ_32.dds',  1, 1),
('FLESHBORN_CIV_ALPHA_ATLAS', 128, 'Fleshborn_Civ_Alpha_128.dds', 1, 1),
('FLESHBORN_CIV_ALPHA_ATLAS', 64,  'Fleshborn_Civ_Alpha_64.dds',  1, 1),
('FLESHBORN_CIV_ALPHA_ATLAS', 48,  'Fleshborn_Civ_Alpha_48.dds',  1, 1),
('FLESHBORN_CIV_ALPHA_ATLAS', 32,  'Fleshborn_Civ_Alpha_32.dds',  1, 1),
('FLESHBORN_CIV_ALPHA_ATLAS', 24,  'Fleshborn_Civ_Alpha_24.dds',  1, 1),
('FLESHBORN_CIV_ALPHA_ATLAS', 16,  'Fleshborn_Civ_Alpha_16.dds',  1, 1),
('FLESHBORN_LEADER_ATLAS', 256, 'Fleshborn_Leader_256.dds', 1, 1),
('FLESHBORN_LEADER_ATLAS', 128, 'Fleshborn_Leader_128.dds', 1, 1),
('FLESHBORN_LEADER_ATLAS', 64,  'Fleshborn_Leader_64.dds',  1, 1),
('FLESHBORN_ICON_ATLAS', 256, 'Fleshborn_Icons_256.dds', 4, 4),
('FLESHBORN_ICON_ATLAS', 128, 'Fleshborn_Icons_128.dds', 4, 4),
...
SELECT
 ...
 'Fleshborn_LeaderScene.xml',
 9, 1, 8, 10, 3, 2, 9, 3, 8, 2, 9, 4, 2, 3, 9,
 0, 'FLESHBORN_LEADER_ATLAS'
...
SELECT
 ...
 0, 'FLESHBORN_CIV_ATLAS', 'FLESHBORN_CIV_ALPHA_ATLAS', 'Fleshborn_Map.dds',
 'TXT_KEY_CIV5_DOM_FLESHBORN_TEXT', 'Fleshborn_DOM.dds', '', SoundtrackTag
...
UPDATE Units SET PortraitIndex = 2, IconAtlas = 'FLESHBORN_ICON_ATLAS'
WHERE Type = 'UNIT_FLESHBORN_DEVOURER';
...
UPDATE Units SET PortraitIndex = 9, IconAtlas = 'FLESHBORN_ICON_ATLAS'
WHERE Type = 'UNIT_FLESHBORN_HARVESTER';
...
UPDATE Units SET PortraitIndex = 10, IconAtlas = 'FLESHBORN_ICON_ATLAS'
WHERE Type = 'UNIT_FLESHBORN_COLONY_BUD';
...
-- Core non-resource organisms and every default strategic-resource unit receive
-- civ-specific, maintenance-free biological copies. This adapts automatically
-- to the active CP roster while retaining compatible stock 3D models and flags.
CREATE TEMP TABLE Fleshborn_ResourceRoster AS
SELECT
 U.Type AS OldUnitType,
 CASE U.Type
  WHEN 'UNIT_WARRIOR' THEN 'UNIT_FLESHBORN_HUNTER_FORM'
  WHEN 'UNIT_ARCHER' THEN 'UNIT_FLESHBORN_SPITTER_FORM'
  WHEN 'UNIT_CROSSBOWMAN' THEN 'UNIT_FLESHBORN_SPINECASTER'
  WHEN 'UNIT_MUSKETMAN' THEN 'UNIT_FLESHBORN_WARFORM'
  ELSE 'UNIT_FLESHBORN_BIO_' || SUBSTR(U.Type, 6)
 END AS NewUnitType,
...
WHERE U.Type <> 'UNIT_SWORDSMAN'
  AND (
    U.Type IN ('UNIT_WARRIOR', 'UNIT_ARCHER', 'UNIT_CROSSBOWMAN', 'UNIT_MUSKETMAN')
    OR EXISTS (
...
UPDATE Fleshborn_ResourceUnitCopies SET Description =
 CASE Type
  WHEN 'UNIT_FLESHBORN_HUNTER_FORM' THEN 'TXT_KEY_UNIT_FLESHBORN_HUNTER_FORM'
  WHEN 'UNIT_FLESHBORN_SPITTER_FORM' THEN 'TXT_KEY_UNIT_FLESHBORN_SPITTER_FORM'
  WHEN 'UNIT_FLESHBORN_SPINECASTER' THEN 'TXT_KEY_UNIT_FLESHBORN_SPINECASTER'
  WHEN 'UNIT_FLESHBORN_WARFORM' THEN 'TXT_KEY_UNIT_FLESHBORN_WARFORM'
...
UPDATE Units SET IconAtlas = 'FLESHBORN_ICON_ATLAS', PortraitIndex = CASE Type
 WHEN 'UNIT_FLESHBORN_HUNTER_FORM' THEN 0
 WHEN 'UNIT_FLESHBORN_SPITTER_FORM' THEN 1
 WHEN 'UNIT_FLESHBORN_BIO_HORSEMAN' THEN 0
 WHEN 'UNIT_FLESHBORN_BIO_CHARIOT_ARCHER' THEN 3
 WHEN 'UNIT_FLESHBORN_BIO_KNIGHT' THEN 2
 WHEN 'UNIT_FLESHBORN_BIO_LONGSWORDSMAN' THEN 2
 WHEN 'UNIT_FLESHBORN_BIO_LANCER' THEN 2
 WHEN 'UNIT_FLESHBORN_BIO_CAVALRY' THEN 4
 WHEN 'UNIT_FLESHBORN_SPINECASTER' THEN 3
 WHEN 'UNIT_FLESHBORN_WARFORM' THEN 4
 WHEN 'UNIT_FLESHBORN_BIO_WWI_TANK' THEN 5
 WHEN 'UNIT_FLESHBORN_BIO_TANK' THEN 5
 WHEN 'UNIT_FLESHBORN_BIO_MODERN_ARMOR' THEN 5
 WHEN 'UNIT_FLESHBORN_BIO_IRONCLAD' THEN 8
 WHEN 'UNIT_FLESHBORN_BIO_FRIGATE' THEN 8
 WHEN 'UNIT_FLESHBORN_BIO_BATTLESHIP' THEN 8
 WHEN 'UNIT_FLESHBORN_BIO_TRIPLANE' THEN 6
 WHEN 'UNIT_FLESHBORN_BIO_FIGHTER' THEN 6
 WHEN 'UNIT_FLESHBORN_BIO_JET_FIGHTER' THEN 6
 WHEN 'UNIT_FLESHBORN_BIO_WWI_BOMBER' THEN 7
 WHEN 'UNIT_FLESHBORN_BIO_BOMBER' THEN 7
 WHEN 'UNIT_FLESHBORN_BIO_STEALTH_BOMBER' THEN 7
 WHEN 'UNIT_FLESHBORN_BIO_HELICOPTER_GUNSHIP' THEN 6
 WHEN 'UNIT_FLESHBORN_BIO_ROCKET_ARTILLERY' THEN 3
 WHEN 'UNIT_FLESHBORN_BIO_MECH' THEN 4
 ELSE PortraitIndex
 END
WHERE Type IN (
 'UNIT_FLESHBORN_HUNTER_FORM', 'UNIT_FLESHBORN_SPITTER_FORM',
 'UNIT_FLESHBORN_SPINECASTER', 'UNIT_FLESHBORN_WARFORM',
 'UNIT_FLESHBORN_BIO_HORSEMAN', 'UNIT_FLESHBORN_BIO_CHARIOT_ARCHER',
 'UNIT_FLESHBORN_BIO_KNIGHT', 'UNIT_FLESHBORN_BIO_LONGSWORDSMAN',
 'UNIT_FLESHBORN_BIO_LANCER', 'UNIT_FLESHBORN_BIO_CAVALRY',
 'UNIT_FLESHBORN_BIO_WWI_TANK', 'UNIT_FLESHBORN_BIO_TANK',
 'UNIT_FLESHBORN_BIO_MODERN_ARMOR', 'UNIT_FLESHBORN_BIO_IRONCLAD',
 'UNIT_FLESHBORN_BIO_FRIGATE', 'UNIT_FLESHBORN_BIO_BATTLESHIP',
 'UNIT_FLESHBORN_BIO_TRIPLANE', 'UNIT_FLESHBORN_BIO_FIGHTER',
 'UNIT_FLESHBORN_BIO_JET_FIGHTER', 'UNIT_FLESHBORN_BIO_WWI_BOMBER',
 'UNIT_FLESHBORN_BIO_BOMBER', 'UNIT_FLESHBORN_BIO_STEALTH_BOMBER',
 'UNIT_FLESHBORN_BIO_HELICOPTER_GUNSHIP',
 'UNIT_FLESHBORN_BIO_ROCKET_ARTILLERY', 'UNIT_FLESHBORN_BIO_MECH'
);
...
UPDATE Buildings SET PortraitIndex = 11, IconAtlas = 'FLESHBORN_ICON_ATLAS'
WHERE Type = 'BUILDING_FLESHBORN_DIGESTIVE_CHAMBER';
...
-- The Neural Cluster replaces the active CP Library. Its ordinary
-- population-scaling Science row is intentionally not copied: Lua supplies
-- +1 Science for every 3 Food actually consumed by population instead.
CREATE TEMP TABLE Fleshborn_NeuralCopy AS
SELECT * FROM Buildings WHERE Type = 'BUILDING_LIBRARY';
UPDATE Fleshborn_NeuralCopy SET
 ID = NULL,
 Type = 'BUILDING_FLESHBORN_NEURAL_CLUSTER',
 Description = 'TXT_KEY_BUILDING_FLESHBORN_NEURAL_CLUSTER',
 Civilopedia = 'TXT_KEY_BUILDING_FLESHBORN_NEURAL_CLUSTER_PEDIA',
 Strategy = 'TXT_KEY_BUILDING_FLESHBORN_NEURAL_CLUSTER_STRATEGY',
 Help = 'TXT_KEY_BUILDING_FLESHBORN_NEURAL_CLUSTER_HELP',
 GoldMaintenance = 0,
 FaithCost = -1,
 HurryCostModifier = -1;
...
INSERT INTO Building_YieldChanges
SELECT 'BUILDING_FLESHBORN_NEURAL_CLUSTER', YieldType, Yield
...
INSERT INTO Civilization_BuildingClassOverrides VALUES
('CIVILIZATION_FLESHBORN_CHORUS', 'BUILDINGCLASS_LIBRARY', 'BUILDING_FLESHBORN_NEURAL_CLUSTER');
...
('BUILDINGCLASS_FLESHBORN_NEURAL_SCIENCE', 'BUILDING_FLESHBORN_NEURAL_SCIENCE', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM', -1, -1, -1),
...
('BUILDINGCLASS_FLESHBORN_PUBLIC_OPINION_BUFFER', 'BUILDING_FLESHBORN_PUBLIC_OPINION_BUFFER', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM', -1, -1, -1);
...
(Type, BuildingClass, Description, Help, Cost, FaithCost, GoldMaintenance,
 ...
 NoOccupiedUnhappiness, UnhappinessModifier, UnmoddedHappiness,
 PortraitIndex, IconAtlas) VALUES
('BUILDING_FLESHBORN_METABOLISM', 'BUILDINGCLASS_FLESHBORN_METABOLISM', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM_HELP', -1, -1, 0, NULL, 1, 1, 0, -1, 1, 0, 0, 0, 'BW_ATLAS_1'),
('BUILDING_FLESHBORN_FOUNDING_CORE', 'BUILDINGCLASS_FLESHBORN_FOUNDING_CORE', 'TXT_KEY_BUILDING_FLESHBORN_FOUNDING_CORE', 'TXT_KEY_BUILDING_FLESHBORN_FOUNDING_CORE_HELP', -1, -1, 0, NULL, 1, 1, 0, -1, 1, 0, 0, 0, 'BW_ATLAS_1'),
('BUILDING_FLESHBORN_FIELD_FOOD', 'BUILDINGCLASS_FLESHBORN_FIELD_FOOD', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM', NULL, -1, -1, 0, NULL, 1, 1, 0, -1, 0, 0, 0, 0, 'BW_ATLAS_1'),
('BUILDING_FLESHBORN_EDIBLE_FOOD', 'BUILDINGCLASS_FLESHBORN_EDIBLE_FOOD', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM', NULL, -1, -1, 0, NULL, 1, 1, 0, -1, 0, 0, 0, 0, 'BW_ATLAS_1'),
('BUILDING_FLESHBORN_MEMORY', 'BUILDINGCLASS_FLESHBORN_MEMORY', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM', NULL, -1, -1, 0, NULL, 1, 1, 0, -1, 0, 0, 0, 0, 'BW_ATLAS_1'),
('BUILDING_FLESHBORN_NEURAL_SCIENCE', 'BUILDINGCLASS_FLESHBORN_NEURAL_SCIENCE', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM', NULL, -1, -1, 0, NULL, 1, 1, 0, -1, 0, 0, 0, 0, 'BW_ATLAS_1'),
('BUILDING_FLESHBORN_PRODUCTION_SINK', 'BUILDINGCLASS_FLESHBORN_PRODUCTION_SINK', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM', NULL, -1, -1, 0, NULL, 1, 1, 0, -1, 0, 0, 0, 0, 'BW_ATLAS_1'),
('BUILDING_FLESHBORN_BLOOM', 'BUILDINGCLASS_FLESHBORN_BLOOM', 'TXT_KEY_BUILDING_FLESHBORN_BLOOM', 'TXT_KEY_BUILDING_FLESHBORN_BLOOM_HELP', -1, -1, 0, NULL, 1, 1, 0, -1, 0, 0, 0, 0, 'BW_ATLAS_1'),
('BUILDING_FLESHBORN_PUBLIC_OPINION_BUFFER', 'BUILDINGCLASS_FLESHBORN_PUBLIC_OPINION_BUFFER', 'TXT_KEY_BUILDING_FLESHBORN_METABOLISM', NULL, -1, -1, 0, NULL, 1, 1, 0, -1, 0, 0, 1, 0, 'BW_ATLAS_1');
...
('BUILDING_FLESHBORN_FOUNDING_CORE', 'YIELD_FOOD', 6),
...
('BUILDING_FLESHBORN_NEURAL_SCIENCE', 'YIELD_SCIENCE', 1),
...
DELETE FROM ArtDefine_LandmarkTypes
WHERE Type = 'ART_DEF_IMPROVEMENT_FLESHBORN_FEEDING_FIELD';
...
('PROMOTION_FLESHBORN_HUNGER_1', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_1_HELP', 1, 0, -3,  -2,  -2,  -2,  13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER'),
('PROMOTION_FLESHBORN_HUNGER_2', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_2_HELP', 1, 0, -6,  -3,  -3,  -3,  13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER'),
('PROMOTION_FLESHBORN_HUNGER_3', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_3_HELP', 1, 0, -9,  -5,  -5,  -5,  13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER'),
('PROMOTION_FLESHBORN_HUNGER_4', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_4_HELP', 1, 0, -12, -6,  -6,  -6,  13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER'),
('PROMOTION_FLESHBORN_HUNGER_5', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_5_HELP', 1, 0, -15, -8,  -8,  -8,  13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER'),
('PROMOTION_FLESHBORN_HUNGER_6', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_6_HELP', 1, 0, -18, -9,  -9,  -9,  13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER'),
('PROMOTION_FLESHBORN_HUNGER_7', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_7_HELP', 1, 0, -21, -11, -11, -11, 13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER'),
('PROMOTION_FLESHBORN_HUNGER_8', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_8_HELP', 1, 0, -24, -12, -12, -12, 13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER'),
('PROMOTION_FLESHBORN_HUNGER_9', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_9_HELP', 1, 0, -27, -14, -14, -14, 13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER'),
('PROMOTION_FLESHBORN_HUNGER_10','TXT_KEY_PROMOTION_FLESHBORN_HUNGER', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER_10_HELP',1, 0, -30, -15, -15, -15, 13, 'FLESHBORN_ICON_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_FLESHBORN_HUNGER');
